...
Likewise, data-management processes necessary to decentralized phylogenetic tracking relate directly to broader questions related to on-the-fly binning within the domain of stream processing. % TODO  \citep{OTHERPREPRINT}
...
For long-lived simulation, practical limitations preclude comprehensive records of replication events, which accumulate linearly with elapsed generations.
...
Stratum retention algorithms must decide how many records to discard, but also how remaining records distribute over past time \citep{moreno2022hereditary}.
