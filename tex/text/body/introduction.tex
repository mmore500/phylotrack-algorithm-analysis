...
Likewise, data-management processes necessary to decentralized phylogenetic tracking relate directly to broader questions involving on-the-fly binning within the domain of stream processing. % TODO  \citep{OTHERPREPRINT}
...
% Tuning of stratum retention trade-offs is discussed in \citet{OTHERPREPRINT} as an instance of the more general ``stream curation'' problem. %TODO
