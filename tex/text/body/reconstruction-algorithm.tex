...
First, because spurious differentia collisions bias toward overestimation of relatedness, as noted above in Section \sec{sec:pairwise-relatedness}, branching events in the reconstructed tree will --- on average --- be more recent than in reality.
