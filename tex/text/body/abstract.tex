...
In addition to applications in phylogenetic record keeping that constitute the major focal point herein, the streaming disposal problem arises more generally in reconciling storage limitations with ongoing data feeds of indefinite or indeterminate duration.
...
Next, attention turns to a proposed suite of retention policy algorithms designed to allow a continuum of trade-offs between collection size and temporal coverage for the streaming disposal problem.
