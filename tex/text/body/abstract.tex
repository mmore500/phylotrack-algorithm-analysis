...
Efforts to reconstruct phylogenetic history from biological sequences provide a rich and enduring motivation for statistical and algorithmic innovation.
In addition to practical importance, the challenging, multifaceted nature of phylogenetic inference has cultivated longstanding interest
% because it is important but also uniquely important and difficult.
because it is important but also difficult.
Studies of the phylogenetic dynamics of agent-based evolutionary models motivate a peculiar converse question: how to best engineer tracking to facilitate fast, accurate, and memory-efficient lineage reconstructions?
