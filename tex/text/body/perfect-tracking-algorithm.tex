...
% Add footnote if we change back to sub-linear
...
Although the asymptotic behavior of $E(|T_c|)$ depends on specifics of the evolutionary process, it scales at worst linearly with respect to population size for all realistic models that have been investigated in the literature to our knowledge.  % TODO consult literature and change this back to "linearly or better" but add a footnote
...
The precise asymptotic scaling of $E(|T_c|)$ with respect to population size $N$ depends on the exact model of random replication used \citep{tellierCoalescenceMultipleBranching2014}.
