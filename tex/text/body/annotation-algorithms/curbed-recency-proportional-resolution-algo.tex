...
As Theorem \ref{thm:curbed-recency-proporitonal-resolution-algo-self-consistency} recounts, self-consistency largely arises from peculiarities of stacking monotonically decreasing binary powers.
