...
% ELD: What does fixed-capacity mean here? Is it size?
% (feel free to disregard if its in the glossary)
...
% ELD: "cannot" as in its impossible or as in we haven't figured out how yet?
...
% ELD: "suffers" seems a little harsh - logarthmic isn't that bad. Maybe "exhibits"?
Take $a = \log_b(n)$.
Equivalently, $b^a = n$.
% ELD: I don't think we need to state this both ways
...
% ELD: maybe just say "b" instead of logarthmic base, since you already defined it?
% Also, I'm confused by what this is saying.
% Does RPR grow faster than logarithmic?
...
% ELD: Is this sentence missing a word? Or is it supposed to be "converting"?
...
% ELD: Is this O(1) per point or total?
...
% ELD: what does "aligning at this cadence" mean?
...
% ELD: I tweaked some typos in the sentence above - make sure its still rigt
Consider several non-mutually exclusive possible scenarios transitioning from $n - 1$ to $n$,
% ELD: "that could occur when"
\begin{enumerate}
